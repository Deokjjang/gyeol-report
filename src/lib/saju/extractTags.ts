...
const SHINSAL_TAG_CODES: Readonly<Record<ShinsalCode, SajuTagCode>> = {
  ...
  TWELVE_GEOPSAL: "SHINSAL_TWELVE_GEOPSAL",
  TWELVE_JAESAL: "SHINSAL_TWELVE_JAESAL",
  TWELVE_CHEONSAL: "SHINSAL_TWELVE_CHEONSAL",
  TWELVE_JISAL: "SHINSAL_TWELVE_JISAL",
  TWELVE_NYEONSAL: "SHINSAL_TWELVE_NYEONSAL",
  TWELVE_WOLSAL: "SHINSAL_TWELVE_WOLSAL",
  TWELVE_MANGSINSAL: "SHINSAL_TWELVE_MANGSINSAL",
  TWELVE_JANGSEONGSAL: "SHINSAL_TWELVE_JANGSEONGSAL",
  TWELVE_BANANSAL: "SHINSAL_TWELVE_BANANSAL",
  TWELVE_YEOKMASAL: "SHINSAL_TWELVE_YEOKMASAL",
  TWELVE_YUKHAESAL: "SHINSAL_TWELVE_YUKHAESAL",
  TWELVE_HWAGAE: "SHINSAL_TWELVE_HWAGAE",
};
