...
export const SAJU_SIGNATURE_SCENE_RULES = [
  {
    ...
    sceneLines: [
      ...
      "카톡에서 상대는 감정을 풀고 있는데, 당신은 속으로 그래서 다음 행동은 무엇인지가 먼저 떠오를 수 있습니다.",
  ...
  },
  {
    ...
    sceneLines: [
      ...
      "상대가 따뜻한 말을 기다릴 때 당신은 위로보다 해결책을 먼저 고르는 장면이 생길 수 있습니다.",
    ],
    sceneLine:
  ...
  },
  {
    ...
    sceneLines: [
      ...
      "연인은 서운함을 말하는데, 당신은 왜 그게 문제인지부터 따지고 싶어질 수 있습니다.",
