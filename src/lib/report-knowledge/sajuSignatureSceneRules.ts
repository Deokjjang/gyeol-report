...
export const SAJU_SIGNATURE_SCENE_RULES = [
  {
    ...
    sceneLines: [
      ...
      "카톡에서 상대는 감정을 풀고 있는데, 덕민님은 속으로 그래서 다음 행동은 무엇인지가 먼저 떠오를 수 있습니다.",
      "팀원이 애매하게 말하면 덕민님은 감정보다 담당자, 기준표, 마감선을 먼저 떠올릴 수 있습니다.",
    ],
    sceneLine:
  ...
  },
  {
    ...
    sceneLines: [
      ...
      "필요한 도움을 말로 꺼내기 전까지는 주변에서 덕민님이 어디서 막혔는지 모를 수 있습니다.",
    ],
    sceneLine:
  ...
  },
  {
    ...
    sceneLines: [
      ...
      "상대가 따뜻한 말을 기다릴 때 덕민님은 위로보다 해결책을 먼저 고르는 장면이 생길 수 있습니다.",
    ],
    sceneLine:
