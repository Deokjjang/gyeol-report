...
const dayPillarEntries = [
  dayPillarEntry({
    ...
    summary: "갑목과 신금, 편관 압박, 생존 긴장, 압박 속 리더십이 함께 보이는 일주입니다.",
    ...
    strength: ["압박 속에서도 방향을 세우는 리더십이 살아납니다.", "날카로운 판단과 자기관리 감각이 강점입니다."],
  ...
  dayPillarEntry({
    ...
    labelKo: "기해일주",
    aliases: ["己亥", "기해", "기해일주"],
    coreImageKo: "깊은 물 위의 부드러운 흙",
    summary: "부드러운 흙 아래 깊은 물이 있어 현실 감각과 숨은 민감함이 함께 보이는 일주입니다.",
