...
export function mapComputedSajuFactsToFeatureIds(
  ...
  const extraction = extractComputedSajuFeatures({
    ...
    earthlyBranches: facts.earthlyBranches,
    heavenlyStems: facts.heavenlyStems,
    fiveElementCounts: facts.fiveElementCounts,
    excessiveElements: facts.excessiveElements,
    missingElements: facts.missingElements,
    tenGodSignals: facts.tenGodSignals,
    specialPatterns: facts.specialPatterns,
    existingSinsal: facts.sinsal,
    existingGwiin: facts.gwiin,
  });
