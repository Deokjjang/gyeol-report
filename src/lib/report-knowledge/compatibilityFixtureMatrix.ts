...
export const COMPATIBILITY_FIXTURE_MATRIX = [
  ...
  {
    id: "deokmin-sodam-marriage",
    label: "Deokmin ENTJ x Sodam INTP marriage fixture",
    input: compatibilityInput({
  ...
  {
    id: "family-unknown-mbti",
    label: "Family fixture with one missing MBTI",
    input: compatibilityInput({
    ...
    expectedPillars: {
      personA: reflectiveInfp.expectedPillars,
      personB: istjResponsibility.expectedPillars,
    },
    personASajuFacts: reflectiveInfp.sajuFacts,
    personBSajuFacts: istjResponsibility.sajuFacts,
  },
  {
    id: "business-work-partner-sample",
    label: "Business work partner fixture with both MBTI known",
    input: compatibilityInput({
