...
const MBTI_STYLE_DESCRIPTIONS: Readonly<Record<MbtiType, string>> = {
  INTJ: "큰 그림을 먼저 세우고, 구조 안에서 조용히 완성도를 높이는 구조 설계형에 가깝습니다. 일에서는 기준을 먼저 세우고 긴 호흡으로 설계를 다듬을 때 강점이 살아날 수 있습니다.",
  INTP: "원리를 파고들고, 납득되는 기준을 찾을 때 사고가 선명해지는 원리 탐색형에 가깝습니다. 복잡한 문제를 분해하고 새 설명을 만드는 장면에서 힘이 살아날 수 있습니다.",
  ENTJ: "목표를 세우고, 구조를 만들고, 빠르게 밀고 가는 전략 추진형에 가깝습니다. 일에서는 기준과 속도를 함께 잡으며 사람과 자원을 움직이는 역할에서 강점이 살아날 수 있습니다.",
  ENTP: "가능성을 열어 두고, 새 관점으로 판을 바꾸어 보는 관점 전환형에 가깝습니다. 토론, 실험, 아이디어 전환이 필요한 장면에서 에너지가 살아날 수 있습니다.",
  INFJ: "사람과 흐름의 의미를 읽고, 조용히 방향을 정리하는 의미 통찰형에 가깝습니다. 관계와 목적이 연결될 때 오래 가는 집중력이 살아날 수 있습니다.",
  INFP: "가치와 진정성을 중요하게 보고, 마음이 향하는 기준에 깊게 몰입하는 가치 몰입형에 가깝습니다. 스스로 납득되는 의미를 찾을 때 표현과 선택이 선명해질 수 있습니다.",
  ENFJ: "사람의 반응과 팀의 방향을 함께 보며 이끄는 관계 리드형에 가깝습니다. 상대의 동기와 분위기를 읽고 공동의 방향을 만드는 장면에서 강점이 살아날 수 있습니다.",
  ENFP: "새 가능성을 빠르게 발견하고 사람과 아이디어를 연결하는 가능성 확장형에 가깝습니다. 새로운 만남과 실험 속에서 선택지가 넓어질 때 에너지가 살아날 수 있습니다.",
  ISTJ: "정해진 기준과 절차를 지키며 안정적으로 완성하는 기준 보존형에 가깝습니다. 반복되는 일을 정확하게 관리하고 신뢰를 쌓는 장면에서 강점이 살아날 수 있습니다.",
  ISFJ: "주변의 필요를 세심하게 살피고 안정감을 만드는 안정 지원형에 가깝습니다. 관계의 작은 변화를 챙기고 실질적인 도움을 정리할 때 힘이 살아날 수 있습니다.",
  ESTJ: "현실 조건을 빠르게 정리하고 실행 구조를 만드는 운영 정리형에 가깝습니다. 역할, 일정, 기준을 분명히 나누는 장면에서 강점이 살아날 수 있습니다.",
  ESFJ: "관계의 분위기와 실제 도움을 함께 챙기는 관계 조율형에 가깝습니다. 사람 사이의 흐름을 안정시키고 필요한 지원을 연결할 때 힘이 살아날 수 있습니다.",
  ISTP: "상황을 관찰한 뒤 필요한 해결책을 빠르게 찾는 문제 해결형에 가깝습니다. 직접 만지고 확인하며 원인을 좁혀 가는 장면에서 강점이 살아날 수 있습니다.",
  ISFP: "감각과 분위기를 세밀하게 느끼고 자연스럽게 조율하는 감각 조율형에 가깝습니다. 말보다 결과물과 분위기로 마음을 표현할 때 편안해질 수 있습니다.",
  ESTP: "현장에서 바로 판단하고 움직이며 흐름을 만드는 현장 실행형에 가깝습니다. 빠른 대응과 실제 경험이 필요한 장면에서 에너지가 살아날 수 있습니다.",
  ESFP: "사람과 분위기 속에서 에너지를 살리고 표현하는 분위기 표현형에 가깝습니다. 감각적 경험과 즉각적인 반응이 있는 장면에서 강점이 살아날 수 있습니다.",
};
...
function createMbtiProfileBlocks(input: ReportInput): ReportBlock[] {
  return [
    ...
    },
    {
      ...
      titleKo: "자기보고 해석 기준",
      bodyKo:
        "MBTI는 사주를 대체하는 기준이 아니라, 내가 익숙하게 선택하는 생각·판단·소통 방식을 보여주는 자기보고 도구입니다.",
    },
    {
      kind: "BULLET_LIST",
      titleKo: "일·관계·자기관리 스타일",
      itemsKo: [
        "일에서는 의사결정 속도, 기준을 세우는 방식, 사람과 정보를 다루는 순서에서 MBTI 성향이 드러나기 쉽습니다.",
        "관계에서는 표현을 먼저 하는지, 정리를 먼저 하는지, 감정 신호를 어떻게 확인하는지가 중요한 차이로 나타날 수 있습니다.",
        "자기관리에서는 성향을 고치는 것보다, 에너지가 빨리 닳는 장면과 회복이 쉬운 장면을 구분하는 것이 도움이 됩니다.",
      ],
    },
    {
      kind: "BULLET_LIST",
...
function createSajuMbtiConnectionBlocks(input: ReportInput): ReportBlock[] {
  ...
  return [
    ...
    {
      kind: "PARAGRAPH",
      titleKo: "겹침과 차이를 보는 법",
      bodyKo:
        "사주와 MBTI가 겹치는 부분은 자주 쓰는 습관으로, 다르게 보이는 부분은 상황에 따라 달라지는 조절 지점으로 읽는 편이 안전합니다.",
    },
    {
      kind: "BULLET_LIST",
      titleKo: "겹치는 점",
