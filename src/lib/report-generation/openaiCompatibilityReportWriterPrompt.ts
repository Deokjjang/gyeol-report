...
export function buildOpenAICompatibilityReportWriterMessages(input: {
  ...
  return {
    ...
    developer: [
      ...
      "A가 해결이라고 생각하는 말이 B에게 압박으로 들리는 장면, B가 신중함이라고 생각하는 태도가 A에게 회피로 보이는 장면처럼 누가 무엇을 하고 상대가 어떻게 받는지 써라.",
      "좋아 보이는 보완점도 현실적으로 어떤 비용이 생기는지 말하라.",
      "서로의 장점이 어떻게 상대를 살릴 수 있는지와, 같은 장점이 어떻게 상대를 지치게 만들 수 있는지를 같이 써라.",
      "끌림은 있지만 속도와 확정 타이밍이 어긋나면 금방 피곤해지는 조합처럼 장점과 비용을 한 문장 안에서 직접 말하라.",
