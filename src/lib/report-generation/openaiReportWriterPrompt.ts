...
export function buildOpenAIComprehensiveReportWriterMessages(input: {
  ...
  return {
    ...
    developer: [
      ...
      "회의, 카톡, 가족 부탁, 계좌 분리, 전문서 공부, 연애 대화, 밤에 생각이 안 꺼지는 장면을 다양하게 섞어라.",
      ...
      "성격 챕터 예: 회의에서 상대 설명이 끝나기 전에 오류와 결론이 동시에 보이는 장면.",
      ...
      "사용자님은 이런 편입니다보다 사용자님, 이런 상황 자주 나오지 않나요? 같은 체감형 문장으로 시작한다.",
      ...
      "hitReadingLines는 “사용자님, 이런 상황 많지 않나요?”처럼 바로 와닿는 장면 문장이다.",
      ...
      "love_relationships hitReadingLines 예시: 상대가 감정을 말할 때, 사용자님은 위로보다 결론을 먼저 주고 싶어질 수 있습니다.",
      ...
      "final_message 좋은 예: 사용자님은 더 세게 밀어붙이는 법보다 덜 닳게 오래 가는 법을 배워야 합니다.",
    ...
    user: [
      ...
      "좋은 예: 편관은 사용자님을 편하게 두지 않는 압박입니다. 문제가 생기면 내가 처리해야 한다는 감각이 먼저 올라옵니다. 정관은 그 압박을 공식 역할과 명예로 정리하려는 힘입니다.",
      "나쁜 예: 회복을 보완해야 합니다.",
      "좋은 예: 하루 중 아무 성과도 내지 않는 시간을 일정표에 넣어야 합니다. 사용자님에게 휴식은 감정 문제가 아니라 성능 유지 장치입니다.",
      "좋은 예: 사주상 갑신일주와 편관 구조가 먼저 보입니다. 여기에 입력한 MBTI의 해결 중심 성향이 겹치면서, 사용자님은 문제를 보면 기다리기보다 바로 구조를 잡으려는 쪽으로 드러납니다.",
      "나쁜 예: ENTJ라서 리더십이 강합니다.",
      "좋은 직설 예: 사람을 싫어하는 건 아닌데, 비효율적인 사람을 오래 기다리는 데 에너지를 많이 씁니다.",
      "좋은 명중 예: 사용자님, 회의나 대화에서 상대가 한참 설명하기 전에 이미 결론이 보이는 상황 많지 않나요? 문제는 그 결론이 맞아도 상대는 내 말을 자른다고 느낄 수 있다는 점입니다.",
      ...
      "risk_and_growth 좋은 예: 사용자님은 지치기 전까지 멈추는 신호를 잘 못 보는 편일 수 있습니다.",
      ...
      "회의, 카톡, 가족 부탁, 계좌 분리, 전문서 공부, 연애 대화, 밤에 생각이 안 꺼지는 장면을 다양하게 섞는다.",
...
export function buildOpenAIComprehensiveReportRepairMessages(input: {
  ...
  return {
    ...
    developer: [
      ...
      "성격 챕터에는 회의/카톡/팀원/설명/오류/결론 같은 구체 장면을 자연스럽게 넣어라.",
      "치료는 관리, 조정, 생활 조언, 운영법으로 바꿔라.",
