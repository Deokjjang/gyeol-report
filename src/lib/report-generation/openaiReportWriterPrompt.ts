...
export function buildOpenAIComprehensiveReportWriterMessages(input: {
  ...
  return {
    ...
    developer: [
      ...
      "solutionLines는 별도 체크리스트처럼 보이게 쓰지 말고 chapter body와 이어지는 자연스러운 처방 문장으로 쓴다.",
      ...
      "love_relationships.solutionLines는 반드시 맞는 상대, 피해야 할 상대, 보완 기운, MBTI 예시 4가지 처방을 각각 포함한다.",
    ...
    user: [
      ...
      "좋은 처방 예: 결론을 바로 말하기 전에 질문을 한 번 던지세요. 그래서 지금 핵심은 뭐라고 보세요? 이 한 문장만 넣어도 날카로움이 조언으로 바뀝니다.",
      ...
      "work_money_study에는 자격증 공부를 시작했지만 목적이 안 보이면 금방 식는 장면, 전문서를 읽을 때 목차와 실전 적용 포인트부터 보는 장면, 업무에서 누가 정리하지 않으면 본인이 표/문서/기준을 만드는 장면, 돈을 벌 방법은 빨리 보지만 계좌 분리와 방어 규칙이 없으면 새는 장면을 구체적으로 넣는다.",
      ...
      "love_relationships.solutionLines에는 반드시 맞는 상대: ..., 피해야 할 상대: ..., 보완 기운: ..., MBTI 예시: ... 형식의 실천 처방을 넣는다.",
