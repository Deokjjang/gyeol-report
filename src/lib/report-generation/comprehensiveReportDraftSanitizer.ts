...
const REPORT_COPY_REPLACEMENT_RULES: readonly ReplacementRule[] = [
  ...
  { term: "성공 보장", replacement: "성공 가능성" },
  { term: "재물 보장", replacement: "재물 가능성" },
  { term: "관계 보장", replacement: "관계 흐름" },
  { term: "미래 보장", replacement: "미래 흐름" },
  { term: "보장됩니다", replacement: "기대할 수 있습니다" },
  { term: "보장된다", replacement: "단정되지는 않습니다" },
  { term: "보장하는", replacement: "단정하는" },
  { term: "보장", replacement: "가능성" },
  ...
  { term: "evidence packet", replacement: "해석 흐름", caseInsensitive: true },
  ...
  { term: "feature evidence", replacement: "해석 흐름", caseInsensitive: true },
  { term: "selected evidence", replacement: "중요하게 잡힌 흐름", caseInsensitive: true },
  { term: "computed feature", replacement: "원국에서 잡힌 기운", caseInsensitive: true },
  { term: "prompt", replacement: "작성 기준", caseInsensitive: true },
  { term: "시그니처 장면", replacement: "구체적인 장면" },
  { term: "스포트라이트", replacement: "핵심 기운" },
  { term: "사주 근거", replacement: "사주 흐름" },
  { term: "명리학 근거", replacement: "명리학적 흐름" },
  { term: "선택된 근거", replacement: "중요하게 잡힌 흐름" },
  { term: "계산된 근거", replacement: "원국에서 확인된 흐름" },
  { term: "계산된 feature", replacement: "원국에서 잡힌 기운" },
