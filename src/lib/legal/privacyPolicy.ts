...
export const privacyPolicyServiceRetentionKo =
  "생성된 리포트는 생성일로부터 90일간 온라인으로 열람할 수 있습니다. 90일 이후 리포트와 리포트 입력정보는 순차적으로 삭제될 수 있습니다.";

export const privacyPolicyLegalRetentionKo =
  "단, 결제·계약·청약철회·환불·분쟁 처리 관련 기록은 관련 법령에 따라 별도 보관될 수 있습니다.";

export const privacyPolicyOverseasProcessingKo =
  "회사는 서비스 제공을 위해 Supabase, OpenAI API, 호스팅 제공자 등 외부 서비스를 이용할 수 있으며, 일부 서비스는 국외에서 제공될 수 있습니다. 국외에서 처리될 수 있는 항목은 리포트 입력정보, 결제 주문 식별 정보, 리포트 생성 및 열람 정보, 접속기록 등 서비스 제공에 필요한 정보이며, 목적은 데이터 저장, 서비스 운영, 리포트 문장 생성 보조, 웹 호스팅입니다. 리포트 입력정보와 결과는 리포트 생성일로부터 90일 기준으로 처리하되, 결제·계약·청약철회·환불·분쟁 처리 관련 기록은 관련 법령에 따라 별도 보관될 수 있습니다.";
