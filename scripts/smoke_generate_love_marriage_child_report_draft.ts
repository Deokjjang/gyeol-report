...
function buildScreenQaDraft(
  ...
  return {
    ...
    loveStyle: {
      ...
      body:
        "당신은 끌림이 있어도 관계의 속도, 약속, 책임감이 흐릿하면 금방 피로해집니다. 좋아하는 마음을 말보다 행동과 기준으로 확인하려는 쪽에 가깝고, 상대가 자기 생활을 어떻게 운영하는지 꽤 빠르게 봅니다.\n\n그래서 당신에게 연애는 감정만 나누는 일이 아니라 생활 리듬을 맞추는 일입니다. 다정함은 좋지만, 약속이 흔들리고 책임이 흐릿하면 마음이 식기 쉽습니다.",
    ...
    attractionPattern: {
      ...
      body:
        "말을 잘하는 사람보다 자기 일과 생활을 정리하는 사람이 더 크게 들어옵니다. 자율적이지만 책임감 있는 사람, 감정 표현은 부드럽지만 생활 기준이 무너지지 않는 사람이 당신에게 잘 맞기 쉽습니다.\n\nINTJ·INTP처럼 생각이 깊고 독립적인 사람은 당신을 덜 피곤하게 합니다. ENFP처럼 생기와 감정 표현을 보태 주는 사람은 당신의 딱딱함을 누그러뜨릴 수 있고, ISFP처럼 말의 온도를 낮춰 주는 사람은 직설성을 완충해 줄 수 있습니다. 명리적으로는 상관·인성처럼 표현과 완충을 보태 주거나 귀인형 조율감이 있는 사람이 편합니다. 단, 실제 궁합은 상대의 사주와 MBTI까지 함께 봐야 합니다.",
      keyPoints: ["자기관리", "책임감", "현실 감각", "INTJ·INTP·ENFP·ISFP 후보"],
      caution: "호감보다 검증이 앞서면 관계가 면접처럼 느껴질 수 있습니다.",
      repeatedPattern: [
        "상대의 태도와 책임감을 빠르게 봅니다.",
        "관계 초반에 미래 기준까지 함께 계산합니다.",
        "책임 기준이 흐린 사람에게는 호감이 있어도 오래 버티기 어렵습니다.",
        "감정 확인은 많지만 행동 기준이 흐린 사람에게 빠르게 피로해집니다.",
        "갈등 때 침묵이나 회피로 버티는 사람과는 답답함이 커집니다.",
      ],
      betterUse: [
        "처음에는 기준을 묻되 결론은 늦춥니다.",
        "상대의 말보다 반복 행동을 봅니다.",
        "추천 MBTI는 확정 궁합이 아니라 편해지기 쉬운 행동 언어로만 봅니다.",
        "돈과 역할 분담을 흐릿하게 두려는 관계는 초반부터 기준을 확인합니다.",
      ],
    },
    loveStrengths: {
    ...
    loveFriction: {
      ...
      body:
        "문제를 바로 짚는 힘이 있지만, 가까운 관계에서는 해결보다 공감이 먼저 필요할 때가 있습니다. 당신은 틀린 부분을 고치려고 말하는데, 상대는 그 말을 평가나 지적으로 받을 수 있습니다.\n\n여기서 핵심은 말을 약하게 하는 것이 아니라 순서를 바꾸는 일입니다. 감정을 한 번 받아 준 뒤 기준을 말하면, 당신의 정확함은 공격이 아니라 관계를 정리하는 힘이 됩니다.",
    ...
    marriageRhythm: {
      ...
      body:
        "결혼 생활은 감정보다 반복되는 생활 기준이 중요합니다. 당신은 사랑한다는 말보다 돈, 시간, 집안일, 가족 행사 기준이 실제로 맞는지를 봅니다.\n\n이 기준이 맞으면 오래 안정됩니다. 반대로 역할이 흐릿하거나 책임이 한쪽으로 몰리면, 애정이 있어도 관계가 관리 업무처럼 느껴질 수 있습니다.",
    ...
    householdMoneyAndRoleSplit: {
      ...
      body:
        "공동비, 개인비, 저축, 가족 지원 기준을 흐릿하게 두면 감정 갈등으로 번지기 쉽습니다. 당신은 돈 문제를 사랑의 크기로 보기보다 신뢰와 책임의 운영 방식으로 봅니다.\n\n그래서 숫자와 역할을 먼저 맞추는 편이 관계를 보호합니다. 돈 이야기를 피하는 관계보다, 불편해도 기준을 정리하는 관계가 당신에게 더 안전합니다.",
    ...
    conflictRecovery: {
      ...
      body:
        "갈등이 생기면 관계의 결론을 바로 내기보다 무엇이 불편했는지, 어떤 기준이 어긋났는지를 나눠야 합니다. 당신은 문제가 보이면 빨리 정리하고 싶어 하지만, 관계에서는 빠른 결론이 늘 회복으로 이어지지 않습니다.\n\n회복은 감정, 사실, 요청의 순서로 정리할 때 빨라집니다. 감정을 먼저 확인하고, 그다음 장면을 분리하고, 마지막에 바꿀 행동을 요청해야 합니다.",
    ...
    parentMode: {
      ...
      body:
        "당신은 감정만으로 돌보기보다 생활 리듬, 공부 습관, 약속을 잡아주는 역할에 강합니다. 부모가 되었을 때 즉흥적인 위로보다 반복되는 기준과 루틴으로 안정감을 만드는 쪽에 가깝습니다.\n\n다만 내 기준이 아이의 속도보다 앞서지 않게 조절해야 합니다. 잘 키우고 싶은 마음이 강할수록 결과와 효율을 먼저 보게 되기 때문에, 감정 신호를 확인하는 시간을 따로 두는 것이 중요합니다.",
    ...
    breakupReunionPattern: {
      ...
      body:
        "흔들리는 관계에서는 상대의 선택을 예측하기보다 내가 반복하는 반응을 먼저 봐야 합니다. 당신은 불확실성이 길어질수록 결론을 앞당기려 하고, 상대의 태도 변화를 빠르게 평가하려는 쪽으로 움직일 수 있습니다.\n\n이별이나 재회 고민에서 중요한 건 상대가 돌아오는지 맞히는 일이 아닙니다. 내가 어떤 말투, 거리 두기, 빠른 판단을 반복하는지 확인해야 관계를 회복하든 정리하든 덜 흔들립니다.",
