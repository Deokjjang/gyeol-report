...
describe("report result page source", () => {
  it("renders generated report draft sections and safe fallback states", () => {
    const requiredMarkers = [
      ...
      'productPreview.productType === "saju_mbti_full"',
      ...
      'productPreview.productType === "career_money_study"',
      'productPreview.productType === "saju_mbti_compatibility"',
      'productPreview.productType === "love_marriage_child"',
      'productPreview.productType === "major_fortune"',
      'productPreview.productType === "annual_fortune"',
      'productPreview.productType === "saju_mbti_full"',
      "renderProductPreviewCareerMoneyStudyState",
      "renderProductPreviewCompatibilityState",
      "renderProductPreviewLoveMarriageChildState",
      "renderProductPreviewMajorFortuneState",
      ...
      "상세 리포트 생성 대기 중입니다.",
      "리포트 상태를 확인하지 못했습니다",
      "잠시 후 이 주소에서 다시 확인해 주세요.",
      "REPORT_EXPIRED",
      "renderExpiredState",
      '<ReportStatusView state="expired" />',
      "리포트 정보가 올바르지 않습니다.",
